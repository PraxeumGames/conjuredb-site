...
export const INTERP_STATS: InterpStat[] = [
  {n: '2.4–36×', l: 'faster than SQLite across 16 query shapes'},
...
export const INTERP_SCENARIOS: InterpScenario[] = [
  ...
  {q: 'Range top-N', what: 'Filter, sort by score, take 10', sqlite: '32.4 µs', cdb: '5.5 µs', x: '5.9× faster', alloc: '176 B'},
  {q: 'Multi-column distinct', what: 'Distinct over two columns', sqlite: '164 µs', cdb: '13.0 µs', x: '13× faster', alloc: '81 B'},
  {q: 'Sort top-N', what: 'Sort by price, take 10', sqlite: '18.2 µs', cdb: '2.5 µs', x: '7.1× faster', alloc: '280 B'},
  ...
  {q: 'Multi-aggregate', what: 'Count/sum/min/max grouped by a column', sqlite: '150 µs', cdb: '31 µs', x: '4.8× faster', alloc: '139 B'},
