    ...
    "rows": [
      {
        ...
        "cls": "ReleaseCommon",
        "meets": true,
        "dsl": "query GetPlayersByLevelDesc(minLevel: int) -> Player[] {\n    from Player\n    | filter Level > @minLevel\n    | sort -Level\n}",
    ...
    "rows": [
      {
        ...
        "cls": "ReleaseCommon",
        "meets": true,
        "dsl": "query GetPlayerById(playerId: int) -> Player? {\n    from Player\n    | filter Id == @playerId\n}",
      ...
      },
      {
        ...
        "cls": "ReleaseCommon",
        "meets": true,
        "dsl": "query GetPlayerOrders(playerId: int) -> Order[] {\n    from Order\n    | filter PlayerId == @playerId\n    | sort -Amount\n}",
      ...
      },
      {
        ...
        "cls": "ReleaseCommon",
        "meets": true,
        "dsl": "query GetPlayerOrdersWithMinAmount(playerId: int, minAmount: long) -> Order[] {\n    from Order\n    | filter PlayerId == @playerId && Amount > @minAmount\n    | sort -Amount, -Id\n}",
      ...
      },
      {
        ...
        "cls": "ReleaseCommon",
        "meets": true,
        "dsl": "query GetTopOrdersForPlayer(playerId: int, limit: int) -> Order[] {\n    from Order\n    | filter PlayerId == @playerId\n    | sort -Amount, -Id\n    | take @limit\n}",
    ...
    "rows": [
      {
        ...
        "cls": "ReleaseCommon",
        "meets": true,
        "dsl": "query GetTopPlayersByScore(limit: int) -> Player[] {\n    from Player\n    | sort -Score\n    | take @limit\n}",
      ...
      },
      {
        ...
        "cls": "ReleaseCommon",
        "meets": true,
        "dsl": "query GetTop5ByRank() -> PlayerRankView[] {\n    from Player\n    | sort -Score\n    | window (Rnk = rank)\n    | filter Rnk <= 5\n    | select Id, Score, Rnk\n}",
    ...
    "rows": [
      {
        ...
        "cls": "ReleaseCommon",
        "meets": true,
        "dsl": "query GetLevelStats(minCount: int) -> LevelAggregateView[] {\n    from Player\n    | group Level\n    | filter count() > @minCount\n    | select Level, PlayerCount = count(), AvgScore = avg(Score)\n    | sort -PlayerCount\n}",
      ...
      },
      {
        ...
        "cls": "ReleaseCommon",
        "meets": true,
        "dsl": "query GetPlayerOrderStatsTopK(k: int) -> PlayerOrderStatsView[] {\n    from Order o\n    | group o.PlayerId (aggregate { SumAmount = sum(o.Amount), Cnt = count(o.Id), MinA = min(o.Amount), MaxA = max(o.Amount) })\n    | derive { AvgVal = SumAmount / (double)Cnt }\n    | select { PlayerId = o.PlayerId, SumAmount, Cnt, MinA, MaxA, AvgVal }\n    | sort -SumAmount, o.PlayerId\n    | take @k\n}",
      ...
      },
      {
        ...
        "cls": "ReleaseCommon",
        "meets": true,
        "dsl": "query GetWalletRecentRowsWithBalanceStats(playerId: int, currency: string, since: int, limit: int) -> WalletLedgerStatsEntryView[] {\n    from WalletTransaction wt\n    | filter wt.PlayerId == @playerId && wt.Currency == @currency && wt.CreatedAt >= @since\n    | sort -wt.CreatedAt, -wt.Id\n    | take @limit\n    | select { Id = wt.Id, PlayerId = wt.PlayerId, Currency = wt.Currency, Delta = wt.Delta, CreatedAt = wt.CreatedAt, Balance = (from WalletTransaction bal | filter bal.PlayerId == wt.PlayerId && bal.Currency == @currency | select sum(bal.Delta)), EntryCount = (from WalletTransaction cnt | filter cnt.PlayerId == wt.PlayerId && cnt.Currency == @currency | select count(cnt.Id)) }\n}",
    ...
    "rows": [
      {
        ...
        "cls": "ReleaseCommon",
        "meets": true,
        "dsl": "query GetPlayersInGuild(guildId: int) -> PlayerGuildView[] {\n    from Player p\n    | filter p.GuildId == @guildId\n    | join Guild g (p.GuildId == g.Id)\n    | select p.Id, p.Name, p.Level, GuildName = g.Name\n}",
    ...
    "rows": [
      {
        ...
        "cls": "ReleaseCommon",
        "meets": true,
        "dsl": "query GetPlayersWithHighValueOrders(minAmount: long) -> Player[] {\n    from Player p\n    | filter exists(from Order o | filter o.PlayerId == p.Id && o.Amount > @minAmount)\n    | sort -Level\n}",
      ...
      },
      {
        ...
        "cls": "ReleaseCommon",
        "meets": true,
        "dsl": "query GetActivePlayersWithNoOrdersTopK(k: int) -> PlayerIdLevelView[] {\n    from Player p\n    | filter p.IsActive == true\n    | filter not exists(from Order o | filter o.PlayerId == p.Id)\n    | sort -p.Level, p.Id\n    | take @k\n    | select p.Id, p.Level\n}",
      ...
      },
      {
        ...
        "cls": "ReleaseCommon",
        "meets": true,
        "dsl": "query GetGuildsWithPlayersHavingOrders() -> GuildView[] {\n    from Guild g\n    | filter exists( from Player p | filter p.GuildId == g.Id | filter exists(from Order o | filter o.PlayerId == p.Id) )\n    | select { Id = g.Id, Name = g.Name, MinLevel = g.MinLevel }\n}",
    ...
    "rows": [
      {
        ...
        "cls": "ReleaseCommon",
        "meets": true,
        "dsl": "query GetTop3PlayersPerLevel() -> PlayerLevelRowNumberView[] {\n    from Player\n    | sort -Score\n    | window by Level (Rn = row_number)\n    | filter Rn <= 3\n    | select Level, Id, Score, Rn\n}",
      ...
      },
      {
        ...
        "cls": "ReleaseCommon",
        "meets": true,
        "dsl": "query GetPlayersWithMovingAvgScore() -> PlayerMovingAvgView[] {\n    from Player\n    | sort Score\n    | window (MovingAvg = avg Score frame: -2..0)\n    | select Id, Score, MovingAvg\n}",
      ...
      },
      {
        ...
        "cls": "ReleaseCommon",
        "meets": true,
        "dsl": "query GetPlayersWithScoreRankById() -> PlayerRankView[] {\n    from Player\n    | sort Score\n    | window (Rnk = rank)\n    | select Id, Score, Rnk\n    | sort Id\n}",
    ...
    "rows": [
      {
        ...
        "cls": "ReleaseCommon",
        "meets": true,
        "dsl": "query GetPlayersWithOrders_ObjectProjection(orderTake: int) -> PlayerOrdersProjectionView[] {\n    from Player p\n    | filter p.Id <= 256\n    | select { Id = p.Id, Orders = collect p.Orders (sort -Id, take @orderTake, select { Id = Id, Amount = Amount }) }\n}",
    ...
    "rows": [
      {
        ...
        "cls": "ReleaseCommon",
        "meets": true,
        "dsl": "query IntersectPlayerAndItemTiers() -> TierView[] {\n    from Player p\n    | derive { Tier = p.Level / 10 }\n    | select { Tier }\n    | intersect (from Item it | derive { Tier = it.Rarity } | select { Tier })\n    | sort Tier\n}",
      ...
      },
      {
        ...
        "cls": "ReleaseCommon",
        "meets": true,
        "dsl": "query UnionAllPlayerAndItemTiers() -> TierView[] {\n    from Player p\n    | derive { Tier = p.Level / 10 }\n    | select { Tier }\n    | union all (from Item it | derive { Tier = it.Rarity } | select { Tier })\n    | sort Tier\n}",
        "sql": "SELECT Tier\nFROM (\n    SELECT (Level / 10) AS Tier FROM Players\n    UNION ALL\n    SELECT Rarity AS Tier FROM Items\n)\nORDER BY Tier ASC",
      ...
      },
      {
        ...
        "cls": "ReleaseCommon",
        "meets": true,
        "dsl": "query IntersectAllPlayerAndItemTiers() -> TierView[] {\n    from Player p\n    | derive { Tier = p.Level / 10 }\n    | select { Tier }\n    | intersect all (from Item it | derive { Tier = it.Rarity } | select { Tier })\n    | sort Tier\n}",
      ...
      },
      {
        ...
        "cls": "ReleaseCommon",
        "meets": true,
        "dsl": "query ExceptAllPlayerAndItemTiers() -> TierView[] {\n    from Player p\n    | derive { Tier = p.Level / 10 }\n    | select { Tier }\n    | except all (from Item it | derive { Tier = it.Rarity } | select { Tier })\n    | sort Tier\n}",
  ...
  },
  {
    ...
    "rows": [
      ...
      },
      {
        ...
        "cls": "ReleaseCommon",
        "meets": true,
        "dsl": "query GetTopPlayersBySparseCompletedOrders(limit: int, minAmount: long) -> PlayerCompletedOrderAggregateView[] {\n    from Player p\n    | left join Order o (p.Id == o.PlayerId && o.Status == \"Completed\" && o.Amount >= @minAmount)\n    | group p.Id, p.Name (aggregate { CompletedOrderCount = count(o.Id), CompletedOrderAmount = sum(o.Amount) })\n    | sort -CompletedOrderAmount, p.Id\n    | take @limit\n    | select { Id = p.Id, Name = p.Name, CompletedOrderCount, CompletedOrderAmount }\n}",
  ...
  },
  {
    ...
    "rows": [
      ...
      },
      {
        ...
        "cls": "ReleaseCommon",
        "meets": true,
        "dsl": "query GetPlayerWalletRecentDeltas(playerId: int, currency: string, since: int, limit: int) -> WalletLedgerEntryView[] {\n    from WalletTransaction wt\n    | filter wt.PlayerId == @playerId && wt.Currency == @currency && wt.CreatedAt >= @since\n    | sort -wt.CreatedAt, -wt.Id\n    | take @limit\n    | select { Id = wt.Id, PlayerId = wt.PlayerId, Currency = wt.Currency, Delta = wt.Delta, Reason = wt.Reason, CreatedAt = wt.CreatedAt, Balance = (from WalletTransaction bal | filter bal.PlayerId == wt.PlayerId && bal.Currency == @currency | select sum(bal.Delta)) }\n}",
        "sql": "SELECT wt.Id,\n       wt.PlayerId,\n       wt.Currency,\n       wt.Delta,\n       wt.Reason,\n       wt.CreatedAt,\n       (\n           SELECT SUM(bal.Delta)\n           FROM WalletTransactions bal\n           WHERE bal.PlayerId = wt.PlayerId\n             AND bal.Currency = $currency\n       ) AS Balance\nFROM WalletTransactions wt\nWHERE wt.PlayerId = $playerId\n  AND wt.Currency = $currency\n  AND wt.CreatedAt >= $since\nORDER BY wt.CreatedAt DESC, wt.Id DESC\nLIMIT $limit",
